...
import { updateRealtimeAdventure } from "@/app/firebase/firebase-db-adventures";
...
const Grid = (selectedAdventure) => {
    ...
    const [tokens, setTokens] = useState(
        selectedAdventure.selectedAdventure.tokens
    );
  ...
  useEffect(() => {
    if (selectedAdventure.selectedAdventure !== null) {
      updateRealtimeAdventure(adventureId, selectedAdventure.selectedAdventure)
        .then(() => {
