...
//         const unsubscribe = onChildAdded(chatRef, handleNewMessage, (error) => {
//             console.error("Error setting up real-time db listener")
//         });
//         return () => {
...
// /// *** function below is original, tweaking in attempt to debug recursion --Keino:
// // useEffect(() => {
// //     const chatRef = ref(realtimeDB, `global/${roomId}`);
// //     const handleNewMessage = (snapshot) => {
// //         const newMessage = snapshot.val();
